...
Route::middleware(['auth', 'verified', 'u2f', '2fa'])->group(function () {
    ...
    Route::name('workcash.')->group(function () {
        Route::get('/workcash', 'WorkCashController@index')->name('index');
        Route::resource('/workcash/companies', 'Workcash\\CompaniesController');
        
        Route::post('/workcash/companies/{company}/set_active_tab', 'Workcash\\CompaniesController@setActiveTab');
        
        //Coworkers
        Route::get('/workcash/companies/{company}/coworker-modal-data', 'Workcash\\CoworkersController@getCoworkerModalData');
        Route::resource('/workcash/companies/{company}/coworkers', 'Workcash\\CoworkersController')->only(['index', 'store', 'update', 'destroy']);
        
        //Jobs
        Route::resource('/workcash/companies/{company}/jobs', 'Workcash\\JobsController')->only(['index', 'store', 'update', 'destroy']);
        Route::put('/workcash/companies/{company}/jobs/{job}/completed', 'Workcash\\JobsController@completed');
