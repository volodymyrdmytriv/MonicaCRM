        ...
        <div class="container">
            <div class="row section ">
                ...
                <div class="col-xs-12 section-title">
                  <img src="/img/workcash/work.svg" class="icon-section icon-activities">
                  <h3>
                    {{ trans('workcash.section_companies') }}

                    <span class="fr">
                      <a href="{{ route('workcash.companies.create') }}" cy-name="add-company-button" class="btn">{{ trans('workcash.companies_add_company') }}</a>
                    </span>
                  </h3>
                </div>
                ...
                @if ($companies->count() == 0)
                  ...
                  <div class="col-xs-12" cy-name="companies-blank-state">
                    <div class="section-blank">
                      <h3>{{ trans('workcash.companies_blank_title') }}</h3>
                      <a href="{{ route('workcash.companies.create') }}">{{ trans('workcash.companies_add_company') }}</a>
                    </div>
                  </div>
                @else
                
                <div class="col-xs-12 col-md-12 mb4">
                    <ul class="company-list">
                        
                        @foreach($companies as $company)
                        <li class="company-list-item bg-white mb3 br3 ba b--gray-monica">
                            <a href="{{ route('workcash.companies.show', $company) }}" class="flex" >
                            ...
                            <div class="absolute-ns tc edit-company-button">
